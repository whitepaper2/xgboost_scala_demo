...
//    val inputPath = "./src/main/resources/Iris.csv"
//    val nativeModelPath = "./"
//    val pipelineModelPath = "./resources"
////    "cdh217:"
...
//      .getOrCreate()
////    val spark = SparkSession.builder().appName("spark_pyspark").config("hive.metastore.uris", "thrift://cdh218:9083").config("spark.sql.warehouse.dir", "/user/hive/warehouse").enableHiveSupport.getOrCreate
//    // Load dataset
...
//      )
//    )
////    val booster = new LogisticRegression()
